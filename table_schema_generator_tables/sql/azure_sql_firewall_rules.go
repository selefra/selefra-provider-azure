...
type TableAzureSqlFirewallRulesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableAzureSqlFirewallRulesGenerator{}

func (x *TableAzureSqlFirewallRulesGenerator) GetTableName() string {
	return "azure_sql_firewall_rules"
}

func (x *TableAzureSqlFirewallRulesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableAzureSqlFirewallRulesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableAzureSqlFirewallRulesGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableAzureSqlFirewallRulesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			svc := client.(*azure_client.Client).AzureServices().SQL.FirewallRules
...
func (x *TableAzureSqlFirewallRulesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableAzureSqlFirewallRulesGenerator) GetColumns() []*schema.Column {
...
func (x *TableAzureSqlFirewallRulesGenerator) GetSubTables() []*schema.Table {
	return nil
}
