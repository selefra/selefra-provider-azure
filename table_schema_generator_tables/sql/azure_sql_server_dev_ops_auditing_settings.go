...
type TableAzureSqlServerDevOpsAuditingSettingsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableAzureSqlServerDevOpsAuditingSettingsGenerator{}

func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetTableName() string {
	return "azure_sql_server_dev_ops_auditing_settings"
}

func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			svc := client.(*azure_client.Client).AzureServices().SQL.ServerDevOpsAuditingSettings
...
func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetColumns() []*schema.Column {
...
func (x *TableAzureSqlServerDevOpsAuditingSettingsGenerator) GetSubTables() []*schema.Table {
	return nil
}
