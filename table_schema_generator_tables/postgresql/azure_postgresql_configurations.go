...
type TableAzurePostgresqlConfigurationsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableAzurePostgresqlConfigurationsGenerator{}

func (x *TableAzurePostgresqlConfigurationsGenerator) GetTableName() string {
	return "azure_postgresql_configurations"
}

func (x *TableAzurePostgresqlConfigurationsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableAzurePostgresqlConfigurationsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableAzurePostgresqlConfigurationsGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableAzurePostgresqlConfigurationsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			svc := client.(*azure_client.Client).AzureServices().PostgreSQL.Configurations
...
func (x *TableAzurePostgresqlConfigurationsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableAzurePostgresqlConfigurationsGenerator) GetColumns() []*schema.Column {
...
func (x *TableAzurePostgresqlConfigurationsGenerator) GetSubTables() []*schema.Table {
	return nil
}
